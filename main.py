...
def get_color():
    ...
    color_list = ['#348498','#004d61','#348498','#ff502f','#001871']
...
# 公众号推送消息
for user in users:
    send_message(user, accessToken, '慈溪', weather, max_temperature, min_temperature, pipi, lizhi,pop,tips, note_en, note_ch, health_tip, lucky_)
import time
time_duration = 3.5
